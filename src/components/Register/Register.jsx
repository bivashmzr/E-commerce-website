    ...
    <section className='section !py-10'>
            <div className="container">
                <div className="card shadow-md w-[400px] !m-auto rounded-md bg-white !p-4 !px-10"> 
                    <h3 className='text-center text-[19px] text-black !mb-4 !py-1'>Register with a new account</h3>
                    <form className='w-full'>
                        <div className='form-group w-full !mb-5'>
                           <TextField type='email' id="email" label="Full Name" variant="outlined" className='w-full'/>
                        </div>
                        <div className='form-group w-full !mb-5'>
                        ...
                        <p className='text-center !mt-3'>Already have an account? <Link className='Link text-[14px] font-[600]' to="/register">Login</Link></p>
